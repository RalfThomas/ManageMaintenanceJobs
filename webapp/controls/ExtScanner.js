...
sap.ui.define(
    ...
    function(Control, jQuery, JSONModel, MessageToast, ResponsivePopover, List, DisplayListItem, Device) {
        ...
        return Control.extend('zi2d.eam.malfunction.manages1.controls.ExtScanner', {
            metadata: {
                manifest: 'json',
                properties: {
            ...
            init: function() {
                ...
                this._oScanModel = new JSONModel({
                    ...
                    decoderKey: 'PDF417-UII', //this.getDecoderKey(),
            ...
            getSettingsPopover: function() {
                if (!this.oSettingsPopover) {
                    this.oSettingsPopover = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.malfunction.manages1.controls.fragments.settingsPopover', this);
            ...
            _getBarCodeDecoder: function() {
                if (!this._oBarCodeDecoder) {
                    this._oBarCodeDecoder = new ZXing.BrowserBarcodeReader(new Map([
                        ['TRY_HARDER', this.getTryHarder()]
                    ]));
                }
            ...
            _getQRCodeDecoder: function() {
                if (!this._oQRCodeDecoder) {
                    this._oQRCodeDecoder = new ZXing.BrowserQRCodeReader(new Map([
                        ['TRY_HARDER', this.getTryHarder()]
                    ]));
                }
            ...
            _getMultiCodeDecoder: function() {
                if (!this._oMultiCodeDecoder) {
                    this._oMultiCodeDecoder = new ZXing.BrowserMultiFormatReader(new Map([
                        ['TRY_HARDER', this.getTryHarder()]
                    ]));
                }
            ...
            _getScanDialog: function() {
                if (!this._oTD) {
                    this._oTD = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.malfunction.manages1.controls.fragments.scanDialog', this);
            ...
            _getInputDialog: function() {
                if (!this._oID) {
                    this._oID = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.malfunction.manages1.controls.fragments.inputDialog', this);
            ...
            _getDialogHeader: function() {
                if (!this._oHeader) {
                    this._oHeader = sap.ui.xmlfragment(this.getId(), 'zi2d.eam.malfunction.manages1.controls.fragments.toolbar', this);
